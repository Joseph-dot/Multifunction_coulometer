...
void ADS131_Init(void)
{
	...
	ADS131_WRITE_REG((OPCODE_WREG>>8)|CLK1_ADDRESS,CLK1_CLK_DIV_8);		//时钟分频系数，16.384MHz/8 = 2.048MHz
	ADS131_WRITE_REG((OPCODE_WREG>>8)|CLK2_ADDRESS,CLK2_ICLK_DIV_2|CLK2_OSR_2048);		//采样次数 (2.048MHz/2048)/2 = 500Hz
...
void ADS131_GetValue(void)
{
	...
	ads131_value.ADC1_Value=((ads131_data.channel1*VREF)/V_24bit)-channel1_err;
	ads131_value.ADC2_Value=((ads131_data.channel2*VREF)/V_24bit)-channel2_err;
	ads131_value.ADC3_Value=((ads131_data.channel3*VREF)/V_24bit)-channel3_err;
	ads131_value.ADC4_Value=((ads131_data.channel4*VREF)/V_24bit)-channel4_err;
...
//		memset(data,0,sizeof(data));
		...
		sprintf((char *)data," ADC1=%.6lf V\r\n ADC2=%.6lf V\r\n ADC3=%.6lf V\r\n ADC4=%.6lf V\r\n",ads131_value.ADC1_Value,ads131_value.ADC2_Value,ads131_value.ADC3_Value,ads131_value.ADC4_Value);
